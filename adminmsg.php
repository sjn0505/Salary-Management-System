...
<a class="margin" href="employee_page1.php">BACK</a><br>
<table id="customers">
	<tr>
				<th>EMP_ID</th>
				<th>MESSAGE</th>
...
$s="SELECT * from adminmsg where emp_id='$emp_id';" ;
  ...
  while($row=mysqli_fetch_array($query_run))
	{
		...
		<table id="customers" >
			<tr>
	     	...
	     	<td>
	     	<?php echo "<a href=adminmsg_view.php?emp_id=".$row['emp_id'].">VIEW</a>" ?></td>
